...
>Descrição:" Simulando operações básicas de um estoque contendo Setters e Getters. método para adicionar uma quantidade ao estoque, método para remover uma
quantidade do estoque (com verificação se há
estoque suficiente), método para exibir as informações do produto e um Método que calcula o valor total do estoque."
